...
func (in *OpsGenieConfig) DeepCopyInto(out *OpsGenieConfig) {
	*out = *in
	...
	if in.Details != nil {
		...
		*out = make(ReceiverConfigDetails, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ReceiverConfigDetails) DeepCopyInto(out *ReceiverConfigDetails) {
	{
		in := &in
		*out = make(ReceiverConfigDetails, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReceiverConfigDetails.
func (in ReceiverConfigDetails) DeepCopy() ReceiverConfigDetails {
	if in == nil {
		return nil
	}
	out := new(ReceiverConfigDetails)
	in.DeepCopyInto(out)
	return *out
}
